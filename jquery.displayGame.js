...
************************   FUNCTIONS   ***********************/
	...
	// 	var points = 0;
	// 	points += parseInt($('.tile-position-' + positions[parseInt(p)]).text(getValue(p)*2));
	// 	console.log("score: " + parseInt(score));
	// 	console.log("points: " + points);
	// 	console.log(addPoints(points));		
	// 	$('.score-container').text(addPoints(points));
	// }
	
// 	function moveRight() {
// 		var positions = ['0-0', '1-0', '2-0', '3-0', '0-1', '1-1', '2-1', '3-1', '0-2', '1-2', '2-2', '3-2', '0-3', '1-3', '2-3', '3-3'];
// 		var isPositionFree = checkPositions();
// 		var offset = 0;

// 		for (var x = 4; x > 0; x--)
// 		{
// 			for (var p = 4*x-2; p >= 4*x-4; p--)
// 			{
// 				if (isPositionFree[p] == false && isPositionFree[p+1] == true) 
// 				{
// 					offset = 1;
// 					if (isPositionFree[p+2] == true && p%4 < 2) {
// 						offset = 2; 
// 						if (isPositionFree[p+3] == true && p%4 < 1) 
// 							offset = 3; 
// 					}
// 				}
// 				if (offset > 0 && isPositionFree[p] == false && isPositionFree[p+offset] == true) {
// 					$('.tile-position-' + positions[parseInt(p)]).addClass('tile-position-' + positions[parseInt(p+offset)]);
// 					$('.tile-position-' + positions[parseInt(p)]).removeClass('tile-position-' + positions[parseInt(p)]);
// 					$('.tile-position-' + positions[parseInt(p+offset)]).removeClass('tile-new');
// 				}
// 			}
// 		}
// 	}
...
// 			for (var p = 4*x-2; p >= 4*x-4; p--)
// 			{
// 				if (isPositionFree[p] == false && isPositionFree[p+1] == false && $('.tile-position-' + positions[parseInt(p)]).text() == $('.tile-position-' + positions[parseInt(p+1)]).text()) {
// 					$('.tile-position-' + positions[parseInt(p+1)]).remove();
// 					$('.tile-position-' + positions[parseInt(p)]).removeClass('tile-' + getValue(p));
// 					$('.tile-position-' + positions[parseInt(p)]).addClass('tile-' + getValue(p)*2);
// 					$('.tile-position-' + positions[parseInt(p)]).text(getValue(p)*2);
// 					$('.tile-position-' + positions[parseInt(p)]).addClass('tile-position-' + positions[parseInt(p+1)]);
// 					$('.tile-position-' + positions[parseInt(p)]).removeClass('tile-position-' + positions[parseInt(p)]);
// 				}
// 			}
// 		}	
...
// 		mergeRight();
// 		moveRight();
// // check case when no tile can move
// 	}
...
// 		for (var p = 4; p < 16; p++)
// 		{
// 			if (isPositionFree[p] == false && isPositionFree[p-4] == true) 
// 			{
// 				offset = 1;
// 				if (isPositionFree[p-8] == true && Math.floor(p/4) > 1) {
// 					offset = 2; 
// 					if (isPositionFree[p-12] == true && Math.floor(p/4) > 2) 
// 						offset = 3; 
// 				}
// 			}
// 			if (offset > 0 && isPositionFree[p] == false && isPositionFree[p-4*offset] == true) {
// 				$('.tile-position-' + positions[parseInt(p)]).addClass('tile-position-' + positions[parseInt(p-4*offset)]);
// 				$('.tile-position-' + positions[parseInt(p)]).removeClass('tile-position-' + positions[parseInt(p)]);
// 				$('.tile-position-' + positions[parseInt(p-4*offset)]).removeClass('tile-new');
// 			}
// 		}
// 	}
...
// 		for (var p = 4; p < 16; p++)
// 		{
// 			if (isPositionFree[p] == false && isPositionFree[p-4] == false && $('.tile-position-' + positions[parseInt(p)]).text() == $('.tile-position-' + positions[parseInt(p-4)]).text()) {
// 				$('.tile-position-' + positions[parseInt(p-4)]).remove();
// 				$('.tile-position-' + positions[parseInt(p)]).removeClass('tile-' + getValue(p));
// 				$('.tile-position-' + positions[parseInt(p)]).addClass('tile-' + getValue(p)*2);
// 				$('.tile-position-' + positions[parseInt(p)]).text(getValue(p)*2);
// 				$('.tile-position-' + positions[parseInt(p)]).addClass('tile-position-' + positions[parseInt(p-4)]);
// 				$('.tile-position-' + positions[parseInt(p)]).removeClass('tile-position-' + positions[parseInt(p)]);
// 			}
// 		}	
// 	}
...
// 			{
// 				offset = 1;
// 				if (isPositionFree[p+8] == true && Math.floor(p/4) < 2) {
// 					offset = 2; 
// 					if (isPositionFree[p-12] == true && Math.floor(p/4) < 1) 
// 						offset = 3; 
// 				}
// 			}
// 			if (offset > 0 && isPositionFree[p] == false && isPositionFree[p+4*offset] == true) {
